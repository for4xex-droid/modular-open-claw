...
def generate_wiki():
    ...
    # Core Wiki Index
    wiki_index = "# 🌌 CODE Wiki - Antigravity\n\n"
    wiki_index += "Welcome to the Antigravity project documentation. This wiki is automatically generated.\n\n"
    ...
    with open(docs_dir / "CODE_WIKI.md", "w", encoding="utf-8") as f:
        f.write(wiki_index)
