...
# Raycast — Prompt Guide

詳細は `raycast.design.md` を参照（オンデマンド）。

## Key Colors

| Role | HEX |
|------|-----|
| Near-Black Blue (page bg) | `#07080a` |
| Surface 100 (cards) | `#101111` |
| Card Surface | `#1b1c1e` |
| Pure White (headings) | `#ffffff` |
| Near White (body) | `#f9f9f9` |
| Raycast Red (brand) | `#FF6363` |
| Raycast Blue (interactive) | `~#55b3ff` |
| Raycast Green (success) | `~#5fc992` |
| Medium Gray (links) | `#9c9c9d` |
| Dim Gray (disabled) | `#6a6b6c` |
| Border | `~#252829` |
| Button Foreground | `#18191a` |

## Typography Essentials

- **Primary**: `Inter` (fallback: Inter Fallback, system sans-serif) — OpenType `calt`, `kern`, `liga`, `ss03` globally
- **System**: `SF Pro Text` for macOS-native UI elements
- **Monospace**: `GeistMono` for code
- **Weights**: 500 as body baseline (not 400); 600 for buttons/hero; positive letter-spacing (+0.2px–+0.4px) on dark UI
