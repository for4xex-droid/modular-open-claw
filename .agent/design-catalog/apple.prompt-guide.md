...
詳細は `apple.design.md` を参照（オンデマンド）。

## Key Colors

| Role | HEX |
|------|-----|
| Pure Black (dark sections) | `#000000` |
| Light Gray (light sections) | `#f5f5f7` |
| Near Black (text) | `#1d1d1f` |
| Apple Blue (CTA/focus) | `#0071e3` |
| Link Blue (light bg) | `#0066cc` |
| Bright Blue (dark bg links) | `#2997ff` |
| White (text on dark) | `#ffffff` |
| Black 80% (secondary) | `rgba(0,0,0,0.8)` |
| Black 48% (tertiary) | `rgba(0,0,0,0.48)` |
| Card Shadow | `rgba(0,0,0,0.22) 3px 5px 30px 0px` |

## Typography Essentials

- **Display**: `SF Pro Display` (20px+) — optical sizing for large text
- **Body**: `SF Pro Text` (19px and below)
- **Weights**: 300 (decorative large), 400 (body), 600 (semibold emphasis/headings), 700 (rare, card titles)
- **Tracking**: negative at all sizes — -0.28px at 56px, -0.374px at 17px, -0.224px at 14px
