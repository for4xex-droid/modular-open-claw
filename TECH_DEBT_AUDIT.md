...
*Generated by `/tech-debt-audit` workflow — 2026-07-10 v11.0（Wave 1/2 完了後差分・ホットスポット再計測・12次元再スキャン）。**消化注記 2026-07-11 /docs-sync**: OP-075-B / App.tsx 分割 / OP-076 を上表に反映。*
