...
// OP-027: Commerce mock is centralized in aiome-commerce (do not re-define here).
use aiome_commerce::mock::MockCommerceEngine;
...
pub async fn create_test_server_with_limit(
    ...
    let commerce_engine = Arc::new(MockCommerceEngine::new());
    ...
    let state = AppState {
        ...
        gig_engine: Component::new(Arc::new(aiome_commerce::gig::UniversalGigEngine::new(
            pool.clone(),
            Arc::new(MockCommerceEngine::new()),
            provider.clone(),
