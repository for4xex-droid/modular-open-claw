...
export interface paths {
    ...
    "/api/v1/commerce/convert-points": {
        ...
        post: operations["convert_points"];
        delete?: never;
        options?: never;
        head?: never;
        patch?: never;
    ...
    "/api/v1/playbooks/import": {
        ...
        post: operations["import_playbook"];
        delete?: never;
        options?: never;
        head?: never;
        patch?: never;
    ...
    "/api/v1/playbooks/{id}/install": {
        ...
        post: operations["install_playbook"];
        delete?: never;
        options?: never;
        head?: never;
        patch?: never;
    ...
    "/api/v1/workflows/{id}/export": {
        ...
        get: operations["export_workflow"];
        put?: never;
        post?: never;
        delete?: never;
        options?: never;
...
export interface components {
    schemas: {
        ...
        /** @description install / import 成功時のレスポンス */
        PlaybookInstallResponse: {
            created_workflow_ids: string[];
            playbook_id: string;
        };
        /** @description Playbook 一覧の1要素 */
        PlaybookSummary: {
            description: string;
            id: string;
            name: string;
        ...
        /** @description ウィッシュリストエントリ（残高不足シグナル） */
        WishlistEntry: {
            /** Format: date-time */
            created_at: string;
            item_id: string;
...
export interface operations {
    ...
    convert_points: {
        ...
        responses: {
            /** @description Creator points converted to AiomeCoin (in-ecosystem) */
            200: {
                headers: {
                    [name: string]: unknown;
                };
    ...
    get_wishlist: {
        ...
        requestBody?: never;
        responses: {
            /** @description Agent wishlist (items they could not afford) */
            200: {
                headers: {
                    [name: string]: unknown;
                };
                content: {
                    "application/json": components["schemas"]["WishlistEntry"][];
                };
            };
            /** @description Unauthorized access */
            403: {
    ...
    list_playbooks: {
        ...
        requestBody?: never;
        responses: {
            /** @description List bundled official playbooks */
            200: {
                headers: {
                    [name: string]: unknown;
                };
                content: {
                    "application/json": components["schemas"]["PlaybookSummary"][];
                };
            };
            /** @description Unauthorized */
            401: {
    ...
    import_playbook: {
        ...
        responses: {
            ...
            /** @description Manifest structure violation */
            400: {
                headers: {
                    [name: string]: unknown;
                };
            ...
            /** @description Missing dependencies (skills / MCP servers) */
            422: {
                headers: {
                    [name: string]: unknown;
                };
    ...
    install_playbook: {
        ...
        requestBody?: never;
        responses: {
            /** @description Playbook installed */
            200: {
                headers: {
                    [name: string]: unknown;
                };
            ...
            /** @description Unknown playbook id */
            404: {
                headers: {
                    [name: string]: unknown;
                };
    ...
    export_workflow: {
        ...
        requestBody?: never;
        responses: {
            /** @description Workflow exported as playbook manifest v1 */
            200: {
                headers: {
                    [name: string]: unknown;
                };
