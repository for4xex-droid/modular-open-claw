...
export const SoulStatusBadge: React.FC<SoulStatusBadgeProps> = ({ 
    ...
    return (
        <>
            ...
            <span style={{ background: 'var(--accent-emerald-10)', color: 'var(--accent-emerald)', padding: '0.2rem 0.6rem', borderRadius: '12px', fontSize: '0.75rem', display: 'flex', alignItems: 'center', gap: '0.25rem' }}>
