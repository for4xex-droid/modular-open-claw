...
> **作成**: 2026-07-13 / **改訂**: 2026-07-14（NT-1 PASS → **NT-5 PASS**）  
...
| NT-6 | OP-070 R5 | **未**（**いま**） | NT-1+2+3 必須。Agent は「NT-6 を実行しろ」まで preflight 禁止 |
...
**ステップ 6 判定**: 追跡ファイル ≤ **2500** かつ合計 ≤ **75MB**。  
...
| NT-1+2+3 済・公開前 | **NT-6（いま）**（「NT-6 を実行しろ」） |
