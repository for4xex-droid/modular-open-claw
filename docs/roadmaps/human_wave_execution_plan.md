...
> **作成**: 2026-07-13 / **改訂**: 2026-07-14（NT-6 preflight **PASS**・R5-5 待ち）  
...
| NT-6 | OP-070 R5 | **PASS**（2026-07-14） | R5-2/Website/vendor除外ゲート解消後に再実行 PASS。**R5-5 は「公開してよい」待ち** |
...
NT-6: PASS 2026-07-14 / 開発機 / preflight PASS / NT-5=7/7 / R5-5=未
