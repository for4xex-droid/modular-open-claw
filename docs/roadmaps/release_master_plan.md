...
- **ステータス**: **Public Beta 公開完了（2026-07-14）** — `v1.2.0` Release。R0〜R5 ゲート完了。**Stripe 方針 B（Live）は OP-084 で 2026-07-18 クローズ**。残 Human フォロー: R4-3/NT-7・ポストリリース。**Wave 1/2 / Top5 消化済**。OP-051 は ADR-054 Proposed。
- **作成日**: 2026-07-05
...
- Upstream: OP-030/031/033/034 / OP-068（**OP-032 ✅**）— 運用は foolproof **§8**（監視のみ時代は終了。α 到達時は β 付き実装可）
