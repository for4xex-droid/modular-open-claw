...
- **作成日**: 2026-07-05
- **ステータス**: 実装進行中（R0/R1/R2 コード完了 — R2-1 Human 待ち / R3-1・R3-2・R3-4 チェックリスト ✅ 2026-07-06 / R3-4 実走 Human 待ち）
...
- 技術的負債系: OP-020〜028, OP-051, OP-054, OP-060(DLQ), OP-061(OXP統一), OP-062, OP-067, OP-068
