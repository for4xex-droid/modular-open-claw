...
> **ステータス**: Wave A1/A2/A3 ✅。NT-1〜6 ✅。**R5-5 / v1.2.0 Public Beta 公開 ✅**（2026-07-14）。**方針 B（OP-084）✅ 2026-07-18**。残: NT-7（任意）/ LL follow（OP-082）/ ポストリリース / closeout R4 任意。**OP-059-UI ✅ / OP-080 ✅ / OP-070 ✅**
