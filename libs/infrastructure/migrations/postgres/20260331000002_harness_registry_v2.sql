-- Postgres Migration: harness_registry_v2
ALTER TABLE harness_registry ADD COLUMN version INTEGER DEFAULT 0;
ALTER TABLE harness_registry ADD COLUMN agent_id UUID;
...
ALTER TABLE harness_registry ADD COLUMN last_fired_at TIMESTAMP WITH TIME ZONE;
