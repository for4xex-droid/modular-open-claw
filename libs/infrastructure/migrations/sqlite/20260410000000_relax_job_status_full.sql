-- Relax job status constraint to allow 'Cancelled', 'Evaluating', 'Quarantined', 'Archived' (Gap 10)
-- SQLite migration to recreate the jobs table with properly updated CHECK constraint
...
CREATE TABLE jobs_new (
    ...
    status TEXT NOT NULL CHECK(status IN ('Pending', 'Processing', 'Completed', 'Failed', 'AwaitingInput', 'Cancelled', 'Evaluating', 'Quarantined', 'Archived')),
    started_at TEXT,
    last_heartbeat TEXT,
