...
```text
API_SERVER_SECRET, ALLOWED_ORIGINS, FEDERATION_SECRET, JWT_PRIVATE_KEY_B64, BG_LLM_PROVIDER, BG_LLM_MODEL, EMBEDDING_PROVIDER, TTS_PROVIDER, TTS_ENDPOINT, XTTS_ENDPOINT, XTTS_SPEAKER, STRIPE_TEST_MODE, SEARCH_API_KEY, PORT, WORKSPACE_DIR, ABYSS_VAULT_PATH, VAULT_MASTER_KEY, DATABASE_URL, SAMSARA_HUB_REST, SAMSARA_HUB_WS, EKYC_RETURN_URL, QUARANTINE_DIR, SHADOW_CLONE_IMAGE
```
