...
mod instantiate_extra_tests {
    ...
    fn test_instantiate_one() {
        ...
        let result = beta_reduce_once(&app).expect("result should be present"); // allow-anti-pattern
        assert_eq!(result, a);
    }
    #[test]
    fn test_unfold_let_one() {
        ...
        let result = unfold_let_one(&let_expr).expect("result should be present"); // allow-anti-pattern
        assert_eq!(result, a);
    }
    #[test]
